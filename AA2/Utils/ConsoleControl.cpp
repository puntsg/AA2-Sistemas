...
ConsoleControl ConsoleControl::GetInstance() {
	static ConsoleControl instance; // crear un singleton (la primera vegada), doncs es crea, i existeix per sempre, si es crida més, s'utiltza la vella variable statica
