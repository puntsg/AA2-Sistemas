...
static class ConsoleControl { //"static" és per fer un singleton, assegurar que ningú pugui crear una nova intáncia d'això
private:
	HANDLE _console = GetStdHandle(STD_OUTPUT_HANDLE); //funció molt cara, millor fer una variable
